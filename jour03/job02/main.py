...
compte1 = CompteBancaire(numero_compte=17540836, nom_client="Boris", prenom_client="Becker", solde_client=2901)
compte1.afficher()
...
compte2 = CompteBancaire(numero_compte=24521335, nom_client="Julie", prenom_client="Franc", solde_client=-589, decouvert=True)
compte2.afficher()
